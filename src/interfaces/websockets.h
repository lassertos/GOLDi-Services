...
#define GOLDi_SERVERADDRESS2 "lora.eichenbergs.de"
#define GOLDi_SERVERPORT 8083
#define GOLDi_WEBCAMPORT 8084

#define COMMUNICATION_PROTOCOL (struct lws_protocols){ "GOLDi-Communication-Protocol", callback_communication, 0, 65536 }
